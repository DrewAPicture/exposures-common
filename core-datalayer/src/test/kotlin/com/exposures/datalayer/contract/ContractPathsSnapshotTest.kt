...
class ContractPathsSnapshotTest {
    ...
    private val expectedPaths = mapOf(
        ...
        "FILM_MEDIA" to "/film-media",
        "EXPOSURES" to "/exposures",
        "PHOTO_STATUSES" to "/photo-status",
        "CAPTURE_RESULT_COMMAND" to "/command/capture-result",
        "COMPLETE_FILM_MEDIUM_COMMAND" to "/command/complete-film-medium",
        "REQUEST_FILM_MEDIA_SYNC_COMMAND" to "/command/request-film-media-sync",
    ...
    fun `DataLayerPaths values match snapshot exactly`() {
        val actual = mapOf(
            ...
            "FILM_MEDIA" to DataLayerPaths.FILM_MEDIA,
            ...
            "COMPLETE_FILM_MEDIUM_COMMAND" to DataLayerPaths.COMPLETE_FILM_MEDIUM_COMMAND,
            "REQUEST_FILM_MEDIA_SYNC_COMMAND" to DataLayerPaths.REQUEST_FILM_MEDIA_SYNC_COMMAND,
